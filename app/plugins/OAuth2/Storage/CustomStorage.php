 ...
 */
class CustomStorage implements
    ...
    OpenIDAuthorizationCodeInterface
{
    ...
    public function __construct($connection, $config = array())
    {
        ...
        $this->config = array_merge($this->config, (array)$globalConfig);
    }
    ...
    public function getUser($email)
    {
        $stmt = $this->db->prepare($sql = sprintf(
            'SELECT u.user_id, u.email, u.password, u.first_name, u.last_name, IFNULL(u.contact_no, "") contact_no,
